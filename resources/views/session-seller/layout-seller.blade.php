...
<li class="menu-item {{ Request::is('seller/profil*') ? 'active open' : '' }}">
  ...
  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
    <div class="avatar avatar-online" style="width: 48px; height: 48px;">
      <img 
        src="{{ Auth::guard('seller')->user()->foto_profil ? asset('storage/' . Auth::guard('seller')->user()->foto_profil) : 'https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y&s=120' }}" 
        alt="user-avatar" 
