...
<li class="menu-item {{ Request::is('seller/profil*') ? 'active open' : '' }}">
        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <!-- /Search -->
                        <!-- /Tandasilang untuk reset keyword -->
  ...
  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
    <div class="avatar avatar-online" style="width: 48px; height: 48px;">
      <img 
        src="{{ Auth::guard('customer')->user()->foto_profil ? asset('storage/' . Auth::guard('customer')->user()->foto_profil) : 'https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y&s=120' }}" 
        alt="user-avatar" 
        class="rounded-circle" 
        style="object-fit: cover; background-color: #f8f9fa; width: 48px; height: 48px;" 
      />
    </div>
  </a>
  <ul class="dropdown-menu dropdown-menu-end">
    <li>
      <a class="dropdown-item" href="{{ route('profil-seller.index') }}">
        <div class="d-flex align-items-center">
          ...
          <div class="flex-grow-1">
            <span class="fw-semibold d-block">{{ Auth::guard('seller')->user()->nama_toko }}</span>
            <small class="text-muted">Seller Toko</small>
          </div>
        </div>
      </a>
    </li>
